...
with open("ukti/datahub/colossus/__init__.py") as f:
...
with open(readme_path) as readme:
    setup(
        ...
        url="https://github.com/UKTradeInvestment/colossus",
        download_url="https://github.com/UKTradeInvestment/colossus",
